...
CURATED_LABEL_DATA = {
    ...
    "Risperidone": {
        ...
        "timeCourse": {
            ...
            "peakWindow": (3, 17, "h", "active metabolite plasma concentration", "9-hydroxyrisperidone peak occurs around 3 hours in extensive metabolizers and around 17 hours in poor metabolizers; this is not a clinical peak-effect time."),
    ...
    "Methylphenidate": {
        ...
        "timeCourse": {
            ...
            "peakWindow": (4.3, 11, "h", "label pharmacokinetics", "Second plasma-concentration peak window for methylphenidate extended-release capsules; product-specific bimodal profile, not a clinical peak-effect time."),
...
DRUGS = [
    ...
    ("Levomepromazine", ["左美丙嗪", "甲氧氯普嗪"], "antipsychotic", ["N05AA02"]),
    ("Promazine", ["丙嗪"], "antipsychotic", ["N05AA03"]),
    ("Melperone", ["美哌隆"], "antipsychotic", ["N05AD03"]),
    ("Sertindole", ["舍吲哚"], "antipsychotic", ["N05AE03"]),
    ("Chlorprothixene", ["氯普噻吨"], "antipsychotic", ["N05AF03"]),
    ("Penfluridol", ["五氟利多"], "antipsychotic", ["N05AG03"]),
    ("Tiapride", ["硫必利"], "antipsychotic", ["N05AL03"]),
    ("Levosulpiride", ["左舒必利"], "antipsychotic", ["N05AL07"]),
    ("Zotepine", ["佐替平"], "antipsychotic", ["N05AX11"]),
    ("Iloperidone", ["伊潘立酮"], "antipsychotic", ["N05AX14"]),
    ("Lumateperone", ["卢美哌隆"], "antipsychotic", ["N05AD10"]),
    ("Blonanserin", ["布南色林"], "antipsychotic", []),
    # Antidepressants
    ...
    ("Mianserin", ["米安色林"], "antidepressant", ["N06AX03"]),
    ("Reboxetine", ["瑞波西汀"], "antidepressant", ["N06AX18"]),
    ("Levomilnacipran", ["左旋米那普仑"], "antidepressant", ["N06AX28"]),
    ("Nefazodone", ["奈法唑酮"], "antidepressant", ["N06AX06"]),
    ("Trimipramine", ["曲米帕明"], "antidepressant", ["N06AA06"]),
    ("Dosulepin", ["度硫平", "多塞平硫代类似物"], "antidepressant", ["N06AA16"]),
    ("Protriptyline", ["普罗替林"], "antidepressant", ["N06AA11"]),
    ("Isocarboxazid", ["异卡波肼"], "antidepressant", ["N06AF01"]),
    ("Selegiline", ["司来吉兰"], "antidepressant", ["N04BD01"]),
    ("Esketamine", ["艾司氯胺酮"], "ketamine", ["N06AX27"]),
    # Mood stabilizers
    ...
    ("Brotizolam", ["溴替唑仑"], "anxiolytic-hypnotic", ["N05CD09"]),
    ("Quazepam", ["夸西泮"], "anxiolytic-hypnotic", ["N05CD10"]),
    ("Loprazolam", ["氯普唑仑"], "anxiolytic-hypnotic", ["N05CD11"]),
    ("Chloral Hydrate", ["水合氯醛"], "anxiolytic-hypnotic", ["N05CC01"]),
    ("Clomethiazole", ["氯美噻唑"], "anxiolytic-hypnotic", ["N05CM02"]),
    ("Meprobamate", ["甲丙氨酯"], "anxiolytic-hypnotic", ["N05BC01"]),
    ("Tasimelteon", ["他司美琼"], "anxiolytic-hypnotic", ["N05CH03"]),
    # ADHD/wakefulness
    ...
    ("Nalmefene", ["纳美芬"], "substance-use", ["N07BB05"]),
]
